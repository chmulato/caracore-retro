...
- **`articles/`** — Diretório contendo todos os 95 artigos HTML
  ...
  - **`articles/assets/`** — Recursos compartilhados
    ...
    - `img/` — Imagens e gráficos dos artigos
    - `js/` — Scripts de funcionalidade

- **`articles.html`** — Página índice com listagem completa e filtros de busca
...
Use a barra de busca em `articles.html` para filtrar por tema, tecnologia ou palavra-chave.
